...
description: >-
  Four slash commands for documentation lifecycle: >-

    /docs, /docs-init, /docs-update, /docs-claude. Create, maintain, and audit CLAUDE.md, README.md, and docs/ structure with smart templates.
