...
> **Status: AKTUEL (kanonisk valideringsrapport).** Denne fil er den ENESTE
...
.agents/scripts/validate-harness.ps1. Se doc-kommentaren i scriptet for
hvilken sektion (A-H) der stammer fra hvilket oprindeligt script.
