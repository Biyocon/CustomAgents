> LANDET fra `.vscode/.codex/Brain/source-map.md` ved PR E (memory-governance), 2026-07-11.
> CANONICAL-klasse (stabil kontekst). FORÆLDET pr. ADR-0003: afsnittet 'Aktiv runtime' beskriver
> det transitionale runtime-lag (genereres ved PR D/F); proveniens-afsnittene (Kombi/Iqra) er
> fortsat gyldige.
...
- `Kombi/Iqra-main/Iqra-main/lib/agents/src/index.ts` - Kanonisk kilde for 11 rige system prompts.  
- `Avatar/Iqra-main.zip` - Original zip-arkiv. 
