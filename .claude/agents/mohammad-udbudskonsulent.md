---
name: mohammad-udbudskonsulent
description: "Udbudskonsulent — Udbud og kontrakt. Banedanmark-harness persona, genereret fra canonical .agents/. Brug ved opgaver inden for Udbud og kontrakt."
---

<!-- GENERERET af .agents/scripts/generate-runtime.py (adapter: claude-code) — haandredigeres aldrig. Canonical kilde: .agents/agents/mohammad-udbudskonsulent/profile.md -->
