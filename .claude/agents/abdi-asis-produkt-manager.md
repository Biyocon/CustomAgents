---
name: abdi-asis-produkt-manager
description: "Technical Product Manager — Produkt og prioritering. Banedanmark-harness persona, genereret fra canonical .agents/. Brug ved opgaver inden for Produkt og prioritering."
---

<!-- GENERERET af .agents/scripts/generate-runtime.py (adapter: claude-code) — haandredigeres aldrig. Canonical kilde: .agents/agents/abdi-asis-produkt-manager/profile.md -->
