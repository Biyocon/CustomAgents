...
description: "LLM Council Orchestrator — Meta og deliberation. Banedanmark-harness persona, genereret fra canonical .agents/. Brug ved opgaver inden for Meta og deliberation."
---

<!-- GENERERET af .agents/scripts/generate-runtime.py (adapter: claude-code) — haandredigeres aldrig. Canonical kilde: .agents/agents/council-chairman/profile.md -->
